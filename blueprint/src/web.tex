...
\home{ https://provables.github.io/sequencelib }
\github{https://github.com/provables/sequencelib }
\dochome{ https://provables.github.io/sequencelib/docs}

\title{ Sequencelib }
\author{ Walter Moreira, Joe Stubbs }
